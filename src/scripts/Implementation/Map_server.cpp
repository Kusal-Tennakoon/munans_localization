...
// Description : ROS node responsible for building and updating the map
//============================================================================
...
// 1)Initializing the ROS node
	...
	map_server_pub = mapServer.advertise<geometry_msgs::PoseStamped>("factor_graph/map_server",1000);

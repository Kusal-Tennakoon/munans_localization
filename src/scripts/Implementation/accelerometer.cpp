//============================================================================
// Name        : acceleromter.cpp
// Author      : Kusal Tennakoon
// Version     :
// Copyright   : MUN/ISL/kbtennakoon
// Description : ROS node publishes the robots approximate pose
//============================================================================
...
// 1)Initializing the ROS node
	...
	accelerometer_pub = accelerometer.advertise<geometry_msgs::PoseStamped>("factor_graph/accelerometer",1000);

	ros::Rate loop_rate(loop_rate);
	
	accelerometer_pose.header.frame_id = "map";

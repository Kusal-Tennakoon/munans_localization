...
// 1.Inputs
    ...
    std::string detector = "Dense";
    std::string descriptor = "SIFT";
    const float scale_factor_1 = 0.25;
    const float scale_factor_2 = 0.25;
    const float SF_feature = 0.25;
    const float visualization_scale_factor = 1;
    const double RANSAC_thresh = 3;
    const double inlier_distance_thresh = 1;
    double inliers = 0;
    float FOV_x = 90.00;
    float FOV_y = 90.00;

    std::string destination_dir  = "/home/lupus/MUN Drive/LUPUS/1-P.hD/1-Projects/1-Ai4L/Feature descriptor comparison/Results/Dense+ SIFT/Aerial/";

    std::string fileName_1 = "/home/lupus/MUN Drive/LUPUS/1-P.hD/1-Projects/1-Ai4L/Feature descriptor comparison/MATLAB/trees1_points.txt";
    std::string fileName_2 = "/home/lupus/MUN Drive/LUPUS/1-P.hD/1-Projects/1-Ai4L/Feature descriptor comparison/MATLAB/trees2_points.txt";
...
// 2.Images
    ...
    // std::string image2 = "/home/lupus/catkin_ws/src/munans_localization/src/Image_Data/360/precise/boxes2.jpg";
    // std::string image1 = "/home/lupus/catkin_ws/src/munans_localization/src/Image_Data/360/precise/boxes1.jpg";
    // std::string image1 = "/home/lupus/catkin_ws/src/munans_localization/src/Image_Data/360/precise/house1.jpg";
    // std::string image2 = "/home/lupus/catkin_ws/src/munans_localization/src/Image_Data/360/precise/house2.jpg";
    // std::string image1 = "/home/lupus/catkin_ws/src/munans_localization/src/Image_Data/Aerial/grass1.JPG";
    // std::string image2 = "/home/lupus/catkin_ws/src/munans_localization/src/Image_Data/Aerial/grass2.JPG";
    std::string image1 = "/home/lupus/catkin_ws/src/munans_localization/src/Image_Data/Aerial/trees1.JPG";
    std::string image2 = "/home/lupus/catkin_ws/src/munans_localization/src/Image_Data/Aerial/trees2.JPG";
    // std::string image1 = "/home/lupus/catkin_ws/src/munans_localization/src/Image_Data/Aerial/structure1.JPG";
    // std::string image2 = "/home/lupus/catkin_ws/src/munans_localization/src/Image_Data/Aerial/structure2.JPG";
    // std::string image1 = "/home/lupus/catkin_ws/src/munans_localization/src/Image_Data/Aerial/carpark1.JPG";
    // std::string image2 = "/home/lupus/catkin_ws/src/munans_localization/src/Image_Data/Aerial/carpark2.JPG";
    ...
    file1.open(fileName_1);
		...
		if (file1.is_open()){
			...
			while(file1 >> feat[0] >> feat[1]){
                ...
                f_known1.push_back(cv::KeyPoint(SF_feature*feat[0],SF_feature*feat[1],float(step_size)));
				i++;
			};
		}		else{
	...
	//Map
		...
		if (file2.is_open()){
			...
			while(file2 >> feat[0] >> feat[1]){
                ...
                f_known2.push_back(cv::KeyPoint(SF_feature*feat[0],SF_feature*feat[1],float(step_size)));
				i++;
			};
		}
		else{
  ...
  // 5.3 Filter matches using the Lowe's ratio test
    ...
    // 5.6 Calculating the no. of inliers
        for(int i = 0; i < match_mask.total(); i++){
            if ((match_mask.at<double>(i) > 0.000)){
                inliers +=1;
            };
        };
...
// //////////////////////
    ...
    // 7.4 Inliers and Outliers
        ...
        for (int i = 0 ; i < kp1.size(); i++){
            ...
            if ((dist_1 <= inlier_distance_thresh) && (dist_2 <= inlier_distance_thresh)){
